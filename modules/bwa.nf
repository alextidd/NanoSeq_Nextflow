...
process BWAMEM2_INDEX {
    ...
    memory { ( task.exitStatus == 130 || task.exitStatus == Integer.MAX_VALUE ) ? 80.GB * task.attempt : 80.GB }
    //
...
process BWAMEM2_MAP {
    ...
    memory { ( task.exitStatus == 130 || task.exitStatus == 140 || task.exitStatus == Integer.MAX_VALUE ) ? 60.GB * task.attempt : 60.GB }
    queue { ( task.exitStatus == 140 || task.exitStatus == Integer.MAX_VALUE ) ? "basement" : QUEUE }
    //
...
process REAMAP_BWAMEM2 {
    ...
    //queue { task.exitStatus == 140 ? "basement" : QUEUE }    
    memory { ( task.exitStatus == 130 || task.exitStatus == 140 || task.exitStatus == Integer.MAX_VALUE ) ? 75.GB * task.attempt : 75.GB }
    queue { ( task.exitStatus == 140 || task.exitStatus == Integer.MAX_VALUE ) ? "basement" : QUEUE }
    //
